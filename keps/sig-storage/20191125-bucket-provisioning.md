...
![](/Users/jcope/Workspace/go/src/github.com/yard-turkey/enhancements/keps/sig-storage/bucket-api-relationships.png)
...
- Sidecar: A COSI maintained controller whose purpose it to watch `BucketAccess` and `BucketContent` API instances and execute methods defined in the COSI interface.
...
- Creating `BucketAccess` and `BucketContent` objects in 

![](/Users/jcope/Workspace/go/src/github.com/yard-turkey/enhancements/keps/sig-storage/bucket-api-controller-arch.png)
