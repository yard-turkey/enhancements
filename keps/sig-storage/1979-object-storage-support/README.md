...
1. `protocolName`: (required) specifies the desired protocol.  One of {“s3”, “gcs”, or “azureBlob”}.
1. `protocolVersion`: (optional) specifies the desired version of the `protocol`. For "s3", a value of "v2" or "v4" could be used. 
...
10. `protocol`: The protocol the application will use to access the backend storage.
   - `protocolName`: Specifies the protocol targeted by this Bucket instance.  Examples:
